...
void timer_init(void){
	...
	DDRC |= _BV(SERVO1) | _BV(SERVO2);  		//PORT initializations for PWM
 							//SERVO1 and SERVO2 defined in timer.h
	...
	TOCPMSA1 = (1 << TOCC7S1) | (1 << TOCC7S0) | 	//route OC1B to TOCC7 (PC7)
                   (1 << TOCC6S1) | (0 << TOCC6S0);  	//route OC1A to TOCC6 (PC6)
...
//	TOCPMSA0 = (RIGHT_PWM_OUT0) | (LEFT_PWM_OUT0);
	...
	OCR1B = 1000; 					//Initial position; corresponds to 1 ms
